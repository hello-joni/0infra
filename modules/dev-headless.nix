...

{
  ...
  home.packages = with pkgs; [
    ...
    # Disk usage by directory, sorted human-readable.
    (writeShellScriptBin ",size" ''
    ...
    # Quick "save" commit: stage everything in the repo root and commit with the
    # verbatim output of `date` as the message.
